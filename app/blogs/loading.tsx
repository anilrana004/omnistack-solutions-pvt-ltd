    ...
    <div className="pt-14 sm:pt-16 min-w-0 overflow-x-hidden">
      ...
      >
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="h-8 sm:h-10 w-48 sm:w-72 mx-auto rounded-xl bg-white/10 border border-white/15 animate-pulse" />
          <div className="mt-4 sm:mt-6 h-4 sm:h-5 w-[min(36rem,90%)] mx-auto rounded-lg bg-white/10 border border-white/15 animate-pulse" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="omni-glass-card overflow-hidden min-w-0">
                <div className="aspect-[16/9] bg-white/10 border-b border-white/15 animate-pulse shrink-0" />
